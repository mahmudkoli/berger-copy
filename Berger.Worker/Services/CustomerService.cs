            ...
            try
            {
                ...
                if (dataFromDatabase != null)
                {
                    ...
                    if (fromDatabase.Count != mappedDataFromApi.Count)
                    {
                        ...
                        var delres = await _repo.UpdateListAsync(deletedList.Item2, nameof(DealerInfo.IsCBInstalled), nameof(DealerInfo.IsExclusive), nameof(DealerInfo.IsLastYearAppointed), nameof(DealerInfo.ClubSupremeType), nameof(DealerInfo.IsAP));
                        if(delres != null)
                        ...
                        if (insertDeleteKeys.Count > 0)
                        {
                            ...
                            if (updatedData.Any())
                            {
                                var updateres = await _repo.UpdateListAsync(updatedData, nameof(DealerInfo.IsCBInstalled), nameof(DealerInfo.IsExclusive), nameof(DealerInfo.IsLastYearAppointed), nameof(DealerInfo.ClubSupremeType), nameof(DealerInfo.IsAP));
                    ...
                    else
                    {
                       ...
                       dataFromDatabase = dataFromDatabase
                        ...
                        var upres = await _repo.UpdateListiAsync(mappedDataFromApi, nameof(DealerInfo.IsCBInstalled), nameof(DealerInfo.IsExclusive), nameof(DealerInfo.IsLastYearAppointed), nameof(DealerInfo.ClubSupremeType), nameof(DealerInfo.IsAP));
