...
{
    public class ODataNotificationService : IODataNotificationService
    {
        private readonly IODataService _odataService;
        private readonly IODataCommonService _odataCommonService;

        public ODataNotificationService(
        ...
        public async Task<IList<AppCreditLimitCrossNotificationModel>> GetAllTodayCreditLimitCrossByDealerIds(List<int> dealerIds)
        {
            var selectQueryBuilder = new SelectQueryOptionBuilder();
