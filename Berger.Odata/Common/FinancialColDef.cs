...
namespace Berger.Odata.Common
{
    public static class FinancialColDef
    {
        ...
        public static string CustomerHigh = "CustomerHigh";
        public static string Date = "Keydate";
        public static string Noteditems = "Noteditems";
        public static string Secindex = "Secindex";
