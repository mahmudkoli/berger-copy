...
@Component({
    ...
    templateUrl: './territory-wise-kpi-target-achivement-report.component.html',
    styleUrls: ['./territory-wise-kpi-target-achivement-report.component.css']
})
export class TerritoryWiseKpiTargetAchivementReportComponent implements OnInit, OnDestroy {
