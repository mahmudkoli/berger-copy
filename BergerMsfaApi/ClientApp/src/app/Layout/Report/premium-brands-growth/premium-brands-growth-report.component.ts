...
import { ActiveSummeryReportQuery, EnamelPaintsQuarterlyGrowthReportQuery, PremiumBrandsGrowthReportQuery, TintingMachineReportQuery } from 'src/app/Shared/Entity/Report/ReportQuery';
...
export class PremiumBrandsGrowthReportComponent implements OnInit, OnDestroy {
	...
	getDownloadDataApiUrl = (query) => this.reportService.downloadPremiumBrandsGrowth(query);
