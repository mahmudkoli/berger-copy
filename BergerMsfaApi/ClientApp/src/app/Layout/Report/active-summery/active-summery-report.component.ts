...
import { ActiveSummeryReportQuery, TintingMachineReportQuery } from 'src/app/Shared/Entity/Report/ReportQuery';
...
export class ActiveSummeryReportComponent implements OnInit, OnDestroy {
	...
	getDownloadDataApiUrl = (query) => this.reportService.downloadActiveSummery(query);
