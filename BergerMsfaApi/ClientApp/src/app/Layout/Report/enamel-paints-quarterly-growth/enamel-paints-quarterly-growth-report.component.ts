...
import { ActiveSummeryReportQuery, EnamelPaintsQuarterlyGrowthReportQuery, TintingMachineReportQuery } from 'src/app/Shared/Entity/Report/ReportQuery';
...
@Component({
    selector: 'app-enamel-paints-quarterly-growth-report',
    templateUrl: './enamel-paints-quarterly-growth-report.component.html',
    styleUrls: ['./enamel-paints-quarterly-growth-report.component.css']
})
export class EnamelPaintsQuarterlyGrowthReportComponent implements OnInit, OnDestroy {

	// data list
	query: EnamelPaintsQuarterlyGrowthReportQuery;
	PAGE_SIZE: number;
	data: any[];
	...
	tableName: string = 'Enamel Paints Quarterly Growth';
	...
	getDownloadDataApiUrl = (query) => this.reportService.downloadEnamelPaintsQuarterlyGrowth(query);
	getData = (query) => this.reportService.getEnamelPaintsQuarterlyGrowth(query);
	...
	searchConfiguration() {
		this.query = new EnamelPaintsQuarterlyGrowthReportQuery({
			page: 1,
