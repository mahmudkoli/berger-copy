...
import { ActiveSummeryReportQuery, BillingDealerQuarterlyGrowthReportQuery, TintingMachineReportQuery } from 'src/app/Shared/Entity/Report/ReportQuery';
...
export class BillingDealerQuarterlyGrowthReportComponent implements OnInit, OnDestroy {
