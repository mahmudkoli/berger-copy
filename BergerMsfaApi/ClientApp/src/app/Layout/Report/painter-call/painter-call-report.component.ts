...
import { LeadGenerationDetailsQuery, PainterRegisterQuery, PaintersCallReportQuery } from 'src/app/Shared/Entity/Report/ReportQuery';
...
export class PainterCallReportComponent implements OnInit, OnDestroy {
	...
	getDownloadDataApiUrl = (query) => this.reportService.downloadPainterCall(query);
