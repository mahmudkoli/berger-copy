...
import { ActiveSummeryReportQuery, EnamelPaintsQuarterlyGrowthReportQuery, PremiumBrandsContributionReportQuery, PremiumBrandsGrowthReportQuery, TintingMachineReportQuery } from 'src/app/Shared/Entity/Report/ReportQuery';
...
export class PremiumBrandsContributionReportComponent implements OnInit, OnDestroy {
	...
	getDownloadDataApiUrl = (query) => this.reportService.downloadPremiumBrandsContribution(query);
