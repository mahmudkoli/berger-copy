	...
	public ptableSettings: IPTableSetting = {
		...
		tableColDef: [
			...
			{ headerName: 'Year Month', width: '10%', internalName: 'yearMonthText', sort: true, type: "" },
		  	{ headerName: 'Slippage Amount', width: '25%', internalName: 'slippageAmount', sort: false, type: "text", displayType: 'number-format-color-fraction'},
			{ headerName: 'Collection Target Amount', width: '25%', internalName: 'collectionTargetAmount', sort: false, type: "text",displayType: 'number-format-color-fraction' },
		],
		enabledSearch: true,
