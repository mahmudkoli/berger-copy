...
export class TintingmachineListComponent implements OnInit, OnDestroy {
	...
	public ptableSettings: IPTableSetting = {
		...
		tableColDef: [
			...
			{ headerName: 'Territory', width: '15%', internalName: 'territory', sort: true, type: "" },
			{ headerName: 'Company Name', width: '15%', internalName: 'companyName', sort: true, type: "" },
			{ headerName: 'No Of Active Machine', width: '15%', internalName: 'noOfActiveMachine', sort: true, type: "" },
			{ headerName: 'No Of Inactive Machine', width: '15%', internalName: 'noOfInactiveMachine', sort: true, type: "" },
			{ headerName: 'No', width: '15%', internalName: 'no', sort: true, type: "" },
			{ headerName: 'Contribution', width: '15%', internalName: 'contribution', sort: true, type: "" },
		],
		enabledSearch: true,
