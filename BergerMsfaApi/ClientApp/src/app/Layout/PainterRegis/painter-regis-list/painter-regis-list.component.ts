 ...
 @ViewChild("paging", { static: false }) paging: Paginator;
    ...
    public ptableSettings: IPTableSetting = {
		...
		tableColDef: [
			...
			{ headerName: 'Painter Image', width: '6%', internalName: 'painterImageUrl', sort: false, type: "image" },
			{ headerName: 'Phone', width: '7%', internalName: 'phone', sort: false, type: "" },
			{ headerName: 'Depot Name', width: '15%', internalName: 'depotName', sort: false, type: "" },
			{ headerName: 'Sale Group Name', width: '10%', internalName: 'saleGroupName', sort: false, type: "" },
			{ headerName: 'Territory', width: '15%', internalName: 'territoryName', sort: false, type: "" },
			{ headerName: 'Zone', width: '15%', internalName: 'zoneName', sort: false, type: "" },
			{ headerName: 'Status', width: '10%', internalName: 'statusText', sort: false, type: "dynamic-button", onClick: 'true', className: 'statusBtnClass', innerBtnIcon: 'statusBtnIcon' },
