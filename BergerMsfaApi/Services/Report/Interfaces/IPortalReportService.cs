...
namespace BergerMsfaApi.Services.Report.Interfaces
{
    public interface IPortalReportService
    {
        ...
        Task<QueryResultModel<LeadBusinessReportResultModel>> GetLeadBusinessUpdateReportAsync(LeadBusinessReportSearchModel query);
        ...
        Task<QueryResultModel<DealerSalesCallReportResultModel>> GetAddhocDealerSalesCallReportAsync(DealerSalesCallReportSearchModel query);
        Task<QueryResultModel<SubDealerSalesCallReportResultModel>> GetAddhocSubDealerSalesCallReportAsync(SubDealerSalesCallReportSearchModel query);
