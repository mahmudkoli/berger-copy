...
namespace Berger.Common.Enumerations
{
    public static class DynamicTypeCode
    {
        ...
        public const string Merchendising = "M01";
        public const string SubDealerInfluence = "SDI01";
        public const string PainterInfluence = "PI01";
        public const string Priority = "P02";
        public const string Satisfaction = "S01";
        public const string TypeOfClient = "TOC01";
        ...
        public const string SwappingCompetition = "SC01"; // Company
